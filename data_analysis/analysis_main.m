...
filename = 'C:\Users\johnf_000\Dropbox\MATLAB\Assignments\Final Project\Analysis\more_trailer_dataNOCOMMA.csv';
delimiter = ',';
startRow = 2;
...
formatSpec = '%*s%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%*s%*s%*s%*s%*s%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%[^\n\r]';
...
Drama = dataArray{:, 31};
Horror = dataArray{:, 32};
Thriller = dataArray{:, 33};
Action = dataArray{:, 34};
Comedy = dataArray{:, 35};
Crime = dataArray{:, 36};
Mystery = dataArray{:, 37};
Sport = dataArray{:, 38};
Romance = dataArray{:, 39};
Biography = dataArray{:, 40};
History = dataArray{:, 41};
Animation = dataArray{:, 42};
Adventure = dataArray{:, 43};
Family = dataArray{:, 44};
Documentary = dataArray{:, 45};
Fantasy = dataArray{:, 46};
Music = dataArray{:, 47};
Western = dataArray{:, 48};
Musical = dataArray{:, 49};
Sports = dataArray{:, 50};
Supernatural = dataArray{:, 51};
War = dataArray{:, 52};
News = dataArray{:, 53};
Animaton = dataArray{:, 54};
Short = dataArray{:, 55};
